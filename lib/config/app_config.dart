...
class AppConfig {
  ...
  static const String paymentSuccessMessage = 'Payment successful! Thank you for your order.';
  static const String paymentFailedMessage = 'Payment failed. Please try again.';

  // Try-On Messages
  static const String tryOnProcessingMessage = 'AI is processing your images...';
  static const String tryOnSuccessMessage = 'Try-on complete! Check your results.';
  static const String tryOnFailedMessage = 'Try-on failed. Please try again.';
  static const String selectDressesMessage = 'Select up to $maxTryOnDresses dresses to try on';
  static const String capturePhotoMessage = 'Capture a full-body photo for best results';
  ...
  static void log(String message) {
    if (debugMode) {
      print('🔹 [VirtualTryOn] $message');
    }
  }

  // Log errors
  static void logError(String error) {
    print('❌ [VirtualTryOn ERROR] $error');
  }
}