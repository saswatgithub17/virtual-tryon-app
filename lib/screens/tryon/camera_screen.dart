// lib/screens/tryon/camera_screen.dart
// FIXED VERSION - No dress parameter needed for camera
...
class CameraScreen extends StatefulWidget {
  // FIXED: Removed dress parameter - camera doesn't need it
...
class _CameraScreenState extends State<CameraScreen>
                  ...
                  child: Container(
                    ...
                    child: const Row(
                      ...
                      children: [
                        ...
                        SizedBox(width: 8),
                        Text(
                          'Take a full-body photo for best results',
                          style: TextStyle(
                            fontSize: 13,
  ...
  Future<void> _confirmPhoto() async {
    ...
    try {
      ...
      // Save to try-on provider
      final tryOnProvider = Provider.of<TryOnProvider>(context, listen: false);
      tryOnProvider.setUserPhoto(_capturedImage);

      if (mounted) {
        // Navigate to dress selection
